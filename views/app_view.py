...
class AppView:
    def __init__(self, root):
        ...
        self.root.geometry("600x200")  # Increase the width of the window
        ...
        self.check_pj_button.grid(row=0, column=2, padx=10, pady=10)
        ...
        self.check_source_branch_button.grid(row=1, column=2, padx=10, pady=10)
        ...
        self.check_target_branch_button.grid(row=2, column=2, padx=10, pady=10)

        # 3rd row: Circular Status light, status text, and "Merge" button
        ...
        self.merge_button.grid(row=3, column=2, padx=10, pady=10)
